...
- 1997-Unscented Kalman Filter-[A New Extension of the Kalman Filter to Nonlinear Systems](https://www.cs.unc.edu/~welch/kalman/media/pdf/Julier1997_SPIE_KF) [![Citation Badge](https://api.juleskreuer.eu/citation-badge.php?doi=10.1117/12.280797)](https://juleskreuer.eu/citation-badge/)
  ...
  - 2002-[The scaled unscented transformation](https://ieeexplore.ieee.org/document/1025369) [![Citation Badge](https://api.juleskreuer.eu/citation-badge.php?doi=10.1109/ACC.2002.1025369)](https://juleskreuer.eu/citation-badge/)
  - 2004-[Sigma-Point Kalman Filters for Probabilistic Inference in Dynamic State-Space Models](https://www.gatsby.ucl.ac.uk/~byron/nlds/merwe2003a.pdf)
...
- 2012-[Implementation of Kalman Filter with Python Language](https://arxiv.org/abs/1204.0375) [![Citation Badge](https://api.juleskreuer.eu/citation-badge.php?doi=10.48550/arXiv.1204.0375)](https://juleskreuer.eu/citation-badge/)
...
- 2017-[Adaptive Adjustment of Noise Covariance in Kalman Filter for Dynamic State Estimation](https://arxiv.org/pdf/1702.00884) [![Citation Badge](https://api.juleskreuer.eu/citation-badge.php?doi=10.1109/PESGM.2017.8273755)](https://juleskreuer.eu/citation-badge/) | [code-shkolnick-kun/yafl](https://github.com/shkolnick-kun/yafl)
...
- [zziz/kalman-filter](https://github.com/zziz/kalman-filter) : Kalman Filter implementation in Python using Numpy only in 30 lines. | Python | ![Github stars](https://img.shields.io/github/stars/zziz/kalman-filter.svg)
